...
while True:
    try:
        entry_price = round(float(input("Prix d'entrée ($) [max 2 décimales] : ")), 2)
        sl_price = round(float(input("Stop Loss ($) [max 2 décimales] : ")), 2)
